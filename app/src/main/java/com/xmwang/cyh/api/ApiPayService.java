...
public interface ApiPayService  {
    ...
    @FormUrlEncoded
    @POST("pay/weixin_pay")
    Observable<BaseResponse<WXPayModel>> weixin_pay(@Field("admin_id") String admin_id,
...
//                                @Field("phone") String phone,
    ...
    @FormUrlEncoded
    @POST("pay/alipay_pay")
    Observable<BaseResponse<AlipayModel>> alipay_pay(@Field("admin_id") String admin_id,
                                                     @Field("user_id") String user_id,
                                                     @Field("order_type") int order_type,
                                                     @Field("allmoney") String allmoney);
    //油卡充值
