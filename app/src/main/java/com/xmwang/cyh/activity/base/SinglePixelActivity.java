package com.xmwang.cyh.activity.base;
...
import com.xmwang.cyh.daijia.IndexActivity;
import com.xmwang.cyh.utils.ScreenManager;
...
//        if(Contants.DEBUG)
        ...
        if(! Common.isAPPALive(this,Common.PACKAGE_NAME)){
            //上线时需要修改
            Intent intentAlive = new Intent(this, IndexActivity.class);
